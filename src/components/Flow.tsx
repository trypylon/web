...
import { AlertCircle, PlayCircle, StopCircle, Trash2, XCircle } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 relative">
        ...
        >
          ...
          <Panel position="top-right" className="flex flex-col items-end space-y-4">
          ...
          {error && (
            <Panel position="top-center" className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 p-3 rounded-lg flex items-center space-x-2">
